...
set QTDIR="C:\Qt\Qt5.13.0\5.13.0\msvc2015_64"
set ERDAS_ECW_INSTALL_DIR="C:\ERDAS ECW JPEG 2000 SDK 5.4.0"

:: Path and directory structure settings
set BASE_3RDPARTY_DIR=%cd%
set PREBUILT_3RDPARTY_DIR=%BASE_3RDPARTY_DIR%\prebuilt
set BUILD_3RDPARTY_DIR=%BASE_3RDPARTY_DIR%\build
set LOG_BUILD_3RDPARTY_DIR=%BUILD_3RDPARTY_DIR%\_build_log
set INSTALL_3RDPARTY_DIR=%BASE_3RDPARTY_DIR%\install
...
call :StartTimer
    ...
    echo --------------------------------------------------
    echo.
    echo Building on %NUM_THREADS% threads:
...
::        PROJ4_LIBRARY_RELEASE     = C:\OSG\3rdparty\install\proj\release\lib\proj_6_1.lib
::        PROJ4_LIBRARY_DEBUG       = C:\OSG\3rdparty\install\proj\debug\lib\proj_6_1_d.lib
...
:: proj.4
    ...
    set PROJ4_LIBRARY_RELEASE=%PROJ4_INSTALL_RELEASE_DIR%\lib\proj_6_1.lib
    set PROJ4_LIBRARY_DEBUG=%PROJ4_INSTALL_DEBUG_DIR%\lib\proj_6_1_d.lib
...
:: GDAL
    ...
    if not %IS_GDAL_BUILD% EQU 1 (
        if %IS_BUILD_RELEASE% EQU 1 (
            cd gdal
            xcopy /Y /Q nmake_release.opt nmake.opt > nul
        ...
        if %IS_BUILD_DEBUG% EQU 1 (
            ...
            cd gdal_debug
            xcopy /Y /Q nmake_debug.opt nmake.opt > nul
